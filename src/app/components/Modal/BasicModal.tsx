...
const BasicModal: FC<Props> = ({ children, show, onCloseModal = () => null, initialFocus, showCloseButton = true }) => {
  return (
    <Transition appear show={show} as={Fragment}>
      <Dialog as="div" className="relative z-modal" onClose={onCloseModal} initialFocus={initialFocus} static={false}>
        <Transition.Child
          as={Fragment}
