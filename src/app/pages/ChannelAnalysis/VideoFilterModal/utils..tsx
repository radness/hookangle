...
export const filterBoundsVideos = (video: IVideo, filter: IChannelVideoFilter) => {
  return (
...
export const filterToggleVideos = (video: IVideo, filter: IChannelVideoFilter) => {
  return (
...
export const filterToFilterParam = (filterData: IChannelVideoFilter): IChannelVideoFilterParam => {
  ...
  const filterParam: IChannelVideoFilterParam = {
...
export const filterParamToFilter = (filterParam: IChannelVideoFilterParam | null): IChannelVideoFilter => {
  if (filterParam === null) {
    return {
